...
router.get('/orientacoes', controller.listarOrientacoes);
router.put('/orientacoes', controller.salvarOrientacoes);
router.post('/orientacoes', controller.salvarOrientacoes);
